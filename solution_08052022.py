...
class CsgoOutcomePredictor():
    ...
    """
    Описание: 
        1. Сервис предусматривает расчет вероятности различных исходов турнирных игр по кс:го
        2. Пайплайн включает в себя этапы:
            2.1. коллекционирование респонсов с играми по кс:го из PandaScore
            2.2. генегирование словарей с признаками для команд и игроков в играх
                2.2.1. паспорт команд и игроков (идентификатор, национальность, возраст и тд)
                2.2.2. агрегирование истории игр команд в разрезе времени, карты, стороны начала, турнира и тд
                       боевая статистика (число убийств, число взрывов бомб и тд)
                       во всех играх команды, в играх команды на карте за сторону,
                        в играх между командой и оппонентом из текущей игры,
                            в играх состава команды из текущей игры
                2.2.3. агрегирование истории игр игроков в разрезе времени, карты, стороны начала 
                       боевая статистика (число убийств, число взрывов бомб и тд)                       
                       во всех играх игрока за команду из текущей игры, за другие команды + на карте за сторону     
            2.3. рекурсивный отбор признаков с помощью важности            
            2.4. оптимизация гиперпараметров CatBoost с помощью optune + рекурсивный отбор признаков с помощью изменения качества при перемешивании
            2.5. простой блендинг комбинаций различной длины из 10 моделей
            2.6. формирование словаря с результатами пайплайна
            2.7. расчет прогнозов для требуемых команд                            
